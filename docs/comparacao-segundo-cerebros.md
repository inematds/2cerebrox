...
**Resumo de uma linha:** *kepano* = escrever o grafo certo · *Obsidian* = o grafo que **você lê** · *graphify* = o grafo que o **agente consulta**, code-first.

---

## 7. Os 3 tipos de cérebro (o frame que organiza tudo)
...
6. **Três camadas distintas, não concorrentes:** organização (Luispitik/inematds) · formato (kepano) · recuperação (graphify). graphify é code-first — pra um second brain de **notas** fica de fora; pra um de **código** é a estrela.
